\begin{longenum}
    ...
    \begin{longenum}
        ...
        \item Filament PHP
    \end{longenum}
    \item \textbf{\textsc{Calidad}} \ce{4f}\ \ev2\ \ra4\ (est: 2026\==01\==21)
    \begin{longenum}
        \item Pruebas
        \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Características adicionales de Laravel}} \ce{9e}\ \ce{9f}\ \ev2\ \ra9\ (est: 2026\==01\==28)
    \begin{longenum}
    ...
    \end{longenum}
    \item \textbf{\textsc{Integración con tecnologías de entorno cliente}} \ce{8a}\ \ce{8b}\ \ce{8c}\ \ce{8d}\ \ce{8e}\ \ce{8f}\ \ce{8g}\ \dual\ \ev2\ \ra8\ (est: 2026\==02\==04)
    \begin{longenum}
        \item Inertia
        \begin{longenum}
            \item Páginas
    ...
    \end{longenum}
    \item \textbf{\textsc{Servicios web con Laravel}} \ce{7a}\ \ce{7b}\ \ce{7c}\ \ce{7d}\ \ce{7e}\ \ce{7f}\ \ce{7g}\ \ce{7h}\ \dual\ \ev3\ \ra7\ (est: 2026\==04\==06)
    \begin{longenum}
        \item Recursos API
        \item Serialización
