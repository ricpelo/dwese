\begin{longenum}
    ...
    \begin{longenum}
        ...
        \item Filament PHP
    \end{longenum}
    \item \textbf{\textsc{Integración con tecnologías de entorno cliente}} \dual\ \ev2\ \ra8\ (est: 2026\==02\==04)
    \begin{longenum}
        \item Inertia
        \begin{longenum}
            \item Páginas
        ...
        \item Starter Kits
    \end{longenum}
    \item \textbf{\textsc{Servicios web con Laravel}} \dual\ \ev3\ \ra7\ (est: 2026\==04\==06)
    \begin{longenum}
        \item Recursos API
        \item Serialización
    ...
    \end{longenum}
    \item \textbf{\textsc{Calidad}} \ce{5h}\ \ev3\ \ra5\ (est: 2026\==05\==04)
    \begin{longenum}
        \item Pruebas
        \begin{longenum}
