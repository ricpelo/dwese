\begin{longenum}
    \item \textbf{\textsc{Introducción a la tecnología web}} \ce{1a}\ \ce{1b}\ \ce{1c}\ \ce{1d}\ \ce{1e}\ \ce{1f}\ \ce{1g}\ \ev1\ \ra1\ (est: 2025\==09\==16)
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Conceptos básicos de PHP (I)}} \ce{2a}\ \ce{2b}\ \ce{2c}\ \ce{2d}\ \ce{2e}\ \ce{2f}\ \ce{2g}\ \ce{2h}\ \ev1\ \ra2\ (est: 2025\==09\==23)
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Conceptos básicos de PHP (II)}} \ce{3a}\ \ce{3b}\ \ce{3c}\ \ce{3d}\ \ce{3e}\ \ce{3f}\ \ce{3g}\ \ev1\ \ra3\ (est: 2025\==09\==30)
    \begin{longenum}
    ...
    \end{longenum}
    \item \textbf{\textsc{Aspectos básicos de orientación a objetos}} \ce{5g}\ \ce{5h}\ \ev1\ \ra5\ (est: 2025\==10\==07)
    \begin{longenum}
        \item Objetos
        \begin{longenum}
            \item \texttt{new}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Persistencia de datos con PHP}} \ce{6a}\ \ce{6b}\ \ce{6c}\ \ce{6d}\ \ce{6e}\ \ce{6f}\ \ce{6g}\ \ev1\ \ra6\ (est: 2025\==10\==14)
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Desarrollo de aplicaciones con PHP}} \ce{4a}\ \ce{4b}\ \ce{4c}\ \ce{4d}\ \ce{4e}\ \ce{4f}\ \ev1\ \ra4\ (est: 2025\==10\==21)
    \begin{longenum}
        \item Cookies
        \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Diseño de aplicaciones orientadas a objetos}} \ce{5g}\ \ce{5h}\ \ev1\ \ra5\ (est: 2025\==10\==28)
    \begin{longenum}
        \item Clases
        \item Propiedades
        \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Interoperabilidad}} \ce{9a}\ \ce{9b}\ \ce{9c}\ \ce{9d}\ \ce{9e}\ \ce{9f}\ \ce{9g}\ \ce{9h}\ \ev1\ \ra9\ (est: 2025\==11\==04)
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Introducción a Laravel}} \ce{5a}\ \ce{5b}\ \ce{5c}\ \ce{5d}\ \ce{5e}\ \ce{5f}\ \ce{5g}\ \ce{5h}\ \ev1\ \ra5\ (est: 2025\==11\==11)
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Visualización de datos en Laravel}} \ce{5a}\ \ce{5b}\ \ce{5c}\ \ce{5d}\ \ce{5e}\ \ce{5f}\ \ce{5g}\ \ce{5h}\ \ev1\ \ra5\ (est: 2025\==11\==18)
    \begin{longenum}
        \item Vistas
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Bases de datos en Laravel}} \ce{6a}\ \ce{6b}\ \ce{6c}\ \ce{6d}\ \ce{6e}\ \ce{6f}\ \ce{6g}\ \ev1\ \ra6\ (est: 2025\==11\==25)
    \begin{longenum}
        \item Conceptos básicos
        \item Query Builder
        \item Migraciones
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Seguridad y autenticación en Laravel}} \ce{4d}\ \ce{4e}\ \ev2\ \ra4\ (est: 2026\==01\==07)
    \begin{longenum}
        \item Cookies
        \item Sesiones
        \item Autenticación
    ...
    \end{longenum}
    \item \textbf{\textsc{Tecnologías asíncronas servidor-cliente}} \ce{8a}\ \ce{8b}\ \ce{8c}\ \ce{8d}\ \ce{8e}\ \ce{8f}\ \ce{8g}\ \ev2\ \ra8\ (est: 2026\==01\==14)
    \begin{longenum}
        \item Livewire
        \begin{longenum}
            \item Alpine.js
        ...
        \item Filament PHP
    \end{longenum}
    \item \textbf{\textsc{Calidad}} \ce{4f}\ \ev3\ \ra4\ (est: 2026\==01\==21)
    \begin{longenum}
        \item Pruebas
        \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Características adicionales de Laravel}} \ce{9e}\ \ce{9f}\ \ev3\ \ra9\ (est: 2026\==01\==21)
    \begin{longenum}
    ...
    \end{longenum}
    \item \textbf{\textsc{Integración con tecnologías de entorno cliente}} \ce{8a}\ \ce{8b}\ \ce{8c}\ \ce{8d}\ \ce{8e}\ \ce{8f}\ \ce{8g}\ \dual\ \ev2\ \ra8\ (est: 2026\==01\==28)
    \begin{longenum}
        \item Inertia
        \begin{longenum}
            \item Páginas
    ...
    \end{longenum}
    \item \textbf{\textsc{Servicios web con Laravel}} \ce{7a}\ \ce{7b}\ \ce{7c}\ \ce{7d}\ \ce{7e}\ \ce{7f}\ \ce{7g}\ \ce{7h}\ \dual\ \ev3\ \ra7\ (est: 2026\==02\==04)
    \begin{longenum}
        \item Recursos API
        \item Serialización
